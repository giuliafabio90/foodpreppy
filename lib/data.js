...
export const INGREDIENT_DB = [
  ...
  { id: "guanciale", name: "Guanciale", categoryId: "carne-rossa", kcal100: 655, protein100: 9.0, carbs100: 0, fat100: 68.0 },
  { id: "pancetta", name: "Pancetta", categoryId: "carne-rossa", kcal100: 457, protein100: 9.0, carbs100: 0.3, fat100: 46.0 },
  { id: "salsiccia", name: "Salsiccia fresca", categoryId: "carne-rossa", kcal100: 311, protein100: 15.0, carbs100: 1.0, fat100: 27.0 },
  { id: "pecorino", name: "Pecorino romano", categoryId: "latticini", kcal100: 387, protein100: 25.0, carbs100: 0, fat100: 32.0 },
  { id: "mascarpone", name: "Mascarpone", categoryId: "latticini", kcal100: 450, protein100: 5.0, carbs100: 4.0, fat100: 47.0 },
  { id: "panna-cucina", name: "Panna da cucina", categoryId: "latticini", kcal100: 337, protein100: 2.4, carbs100: 3.5, fat100: 35.0 },
  { id: "tuorlo", name: "Tuorlo d'uovo", categoryId: "uova", kcal100: 322, protein100: 16.0, carbs100: 3.6, fat100: 27.0 },
  { id: "albume", name: "Albume d'uovo", categoryId: "uova", kcal100: 52, protein100: 11.0, carbs100: 0.7, fat100: 0.2 },
  { id: "prezzemolo", name: "Prezzemolo", categoryId: "verdura", kcal100: 36, protein100: 3.0, carbs100: 6.0, fat100: 0.8 },
  { id: "basilico", name: "Basilico", categoryId: "verdura", kcal100: 23, protein100: 3.2, carbs100: 2.7, fat100: 0.6 },
  { id: "aglio", name: "Aglio", categoryId: "verdura", kcal100: 149, protein100: 6.4, carbs100: 33.0, fat100: 0.5 },
  { id: "cipolla", name: "Cipolla", categoryId: "verdura", kcal100: 40, protein100: 1.1, carbs100: 9.3, fat100: 0.1 },
  { id: "limone", name: "Limone", categoryId: "frutta", kcal100: 29, protein100: 1.1, carbs100: 9.3, fat100: 0.3 },
];
...
// Sostituisce il pasto con una ricetta specifica scelta dall'utente (invece
// che casuale), mantenendo la categoria alimentare della cella.
export function selectMealRecipe(settings, recipes, plan, day, mt, idx, recipeId) {
  ...
  if (!entry || !entry.categoryId || !recipe) return plan;
  const newEntry = { idx, ...computeEntry(settings, mt, entry.categoryId, recipe) };
  return replaceMealEntry(plan, day, mt, idx, newEntry);
}

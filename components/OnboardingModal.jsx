  ...
  return (
    <div className="modal-overlay">
      <div className="modal-card">
        <div className="onboarding-step">Passo {step} di 2</div>

        {step === 1 && (
          <>
            <h3>Benvenuta/o</h3>
            <div className="sub">Un paio di informazioni per impostare subito la Tabella Settimanale su misura per te. Puoi cambiare tutto in seguito dalle Impostazioni.</div>
            <div className="field-grid">
              <label className="field"><span>Come ti chiami?</span>
            ...
            <div className="modal-actions">
              <button className="btn primary" disabled={!step1Valid} onClick={() => setStep(2)}>Avanti</button>
            </div>
          </>
        )}
        ...
        {step === 2 && (
          <>
            <h3>Funzione Family</h3>
            <div className="sub">
              Pianifichi anche per altre persone? Aggiungile qui con il loro target calorico: condividono lo stesso
              piano settimanale (stessa categoria e ricetta per ogni pasto), ma le quantità degli ingredienti si
              ricalibrano sul target di ciascuno. Puoi aggiungerle o toglierle quando vuoi, anche più avanti.
            </div>
            ...
            <div className="modal-actions">
              ...
              <button className="btn primary" onClick={finish}>
                {members.filter((m) => m.name.trim()).length > 0 ? "Fine, inizia a pianificare" : "Salta, inizia a pianificare"}
              </button>
            </div>
          </>
        )}
